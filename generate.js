...
<head>
  ...
  <link rel="canonical" href="[https://yishu.business/cars/$](https://yishu.business/cars/$){car.slug}.html">
  <script type="application/ld+json">
  {
    ...
    "offers": { "@type": "Offer", "price": "${car.price}", "priceCurrency": "USD", "availability": "[https://schema.org/InStock](https://schema.org/InStock)" }
  }
  </script>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    body { background-color: var(--bg); color: var(--text); font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif; line-height: 1.6; overflow-x: hidden; }
    ...
    .badge { background: var(--accent); color: #fff; padding: 0.3rem 0.8rem; font-size: 0.8rem; font-weight: bold; border-radius: 4px; margin-bottom: 1rem; text-transform: uppercase; }
    h1 { font-size: 3.5rem; font-weight: 900; letter-spacing: -1px; margin-bottom: 0.5rem; }
    ...
    .image-container { width: 100%; max-width: 900px; aspect-ratio: 16/9; background: #111; border-radius: 12px; overflow: hidden; box-shadow: 0 20px 40px rgba(0,0,0,0.5); }
    ...
    @media (max-width: 768px) { h1 { font-size: 2.2rem; } .trim { font-size: 1.2rem; } }
  </style>
</head>
<body>
  <header class="hero">
...
cars.forEach(car => {
  ...
  console.log(`✅ Generated: cars/${car.slug}.html`);
});
